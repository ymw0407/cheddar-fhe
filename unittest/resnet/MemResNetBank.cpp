// Wide-bank compressed ResNet driver — 뱅크 N > 슬롯 캡 (천장맥스) 전용
// (2026-08-09). 공유 드라이버(MemResNet.cpp)와의 차이는 단 하나:
// MemBlock -> MemBlockBank (MemOpsBank.h) — 뱅크를 ceil(N/cap) 암호문 조각으로
// 나눠 평가한다. N <= cap 이면 1조각으로 MemBlock 과 동일한 수학.
// 대상 export: rn32c100_lw3_free_Nceil (N=64/256/1024 — 전 스테이지 4조각).
//
...
TEST_P(Testbed32, MemResNetBank) {
